def process_input(all_elf_calories: str) -> list[list[str]]:
    """Read .txt file and read into a list of lists containing calories for each elf"""
    calories = all_elf_calories.split("\n\n")
...
if __name__ == "__main__":
    ...
    with open("input.txt", "r", encoding="utf-8") as input_values:
        all_elf_calories = input_values.read()

    elf_calories = process_input(all_elf_calories)
